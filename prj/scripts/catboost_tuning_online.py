...
def train_with_es(init_model: CatBoostRegressor, params: dict, train_df: pl.DataFrame, val_df: pl.DataFrame, use_weighted_loss, features, iterations, task_type = 'CPU'):
...
if __name__ == '__main__':
    ...
    model_name = f'catboost_online_tuning_{timestamp}' if STUDY_NAME is None else STUDY_NAME

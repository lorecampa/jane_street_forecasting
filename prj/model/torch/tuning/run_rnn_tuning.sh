#!/usr/bin/bash
#SBATCH --job-name ObjectDetection3Dv6
#SBATCH --account DD-24-8
#SBATCH --partition qgpu
#SBATCH --gpus 1
#SBATCH --time 48:00:00
#SBATCH --error /mnt/proj2/dd-24-8/frustum_datasets/last/rnn/job.err
#SBATCH --output /mnt/proj2/dd-24-8/frustum_datasets/last/rnn/job.out
#SBATCH --gres=gpu:1
#SBATCH --nodes 1
...
python $HOME/jane_street_forecasting/prj/model/torch/tuning/rnn.py \
	-output_dir /mnt/proj2/dd-24-8/frustum_datasets/last/rnn \

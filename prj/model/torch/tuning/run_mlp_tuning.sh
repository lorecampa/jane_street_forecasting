...
#SBATCH --error /mnt/proj2/dd-24-8/frustum_datasets/last/mlp_v2/job.err
#SBATCH --output /mnt/proj2/dd-24-8/frustum_datasets/last/mlp_v2/job.out
#SBATCH --gres=gpu:1
#SBATCH --nodes 1
...
python $HOME/jane_street_forecasting/prj/model/torch/tuning/mlp.py \
	-output_dir /mnt/proj2/dd-24-8/frustum_datasets/last/mlp_v2 \
